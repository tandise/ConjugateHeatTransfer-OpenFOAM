...
void Foam::solidWallMixedTemperatureCoupledFvPatchScalarField::updateCoeffs()
{
    ...
    //Info<<nbrMesh.name()<<endl;
    //Info<<nbrPatch.patch()<<endl;
...
const Foam::solidWallMixedTemperatureCoupledFvPatchScalarField&
 Foam::solidWallMixedTemperatureCoupledFvPatchScalarField::nbrField() const
{
